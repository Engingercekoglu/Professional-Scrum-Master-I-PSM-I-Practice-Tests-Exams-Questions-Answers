# ⬆️ Professional Scrum Master I (PSM I) Practice Tests Eams Questions & Answers

![Promotional image](images/promotional.png)

## Udemy & Etsy

❣️ Please support us by purchasing this course on Udemy in an interactive version with the [discounted link](https://www.udemy.com/course/professional-scrum-master-i-psm-i-practice-tests-eams/?referralCode=AE50158A452A3EAB8A7E). If you're working for a company, you could most probably easily claim this epense during preparation for your eam. For us, it's to be, or not to be, in the game.
...
✋ Join a live online community and a course taught by industry eperts and pass the Professional Scrum Master I (PSM I) confidently. We aim to build an ecosystem of Information Technology (IT) certifications and online courses in cooperation with the technology industry. We believe it will give our students 100% confidence in the pacing market in an open-source environment. We are just at the beginning of our way, so it's even better for you to join now!

[![Join our Discord](images/discord.png 'Join our Discord')](https://discord.gg/RFjtKfJy3)

## ⌛️ Short and to the point; why should you take the course:

1. Always happy to answer your questions on Udemy's Q&A's and outside :)
2. Failed? Please submit a screenshot of your eam result and request a refund (via our upcoming platform, not possible on Udemy); we'll always accept it.
3. Learn about topics, such as:
   ...
   - Sprint Review;
   - **Much More!**
4. Questions are similar to the actual eam, without duplications (like in other courses ;-)).
5. The Practice Tests Eams simulate the actual eam's content, timing, and percentage required to pass the eam.
6. This course is **not** a Professional Scrum Master I (PSM I) Eam Dump. Some people use brain dumps or eam dumps, but that's absurd, which we don't practice.
7. 246 **unique** questions.

## ☝️ Course Updates

**[v1.0.0](https://github.com/Ditectrev/Professional-Scrum-Master-I-PSM-I-Practice-Tests-Eams-Questions-Answers/releases/tag/v1.0.0): February 15, 2023.**

- Launch of the course.

**[v1.1.0](https://github.com/Ditectrev/Professional-Scrum-Master-I-PSM-I-Practice-Tests-Eams-Questions-Answers/releases/tag/v1.1.0): May 23, 2023.**

- Fi 15 wrong answers, delete 2 questions, and make other minor improvements.

## 🙋‍♀️ & 🙋‍♂️ Contribution

We are so thankful for every contribution, which makes sure we can deliver top-notch content. Whenever you find a missing resource, broken link in a [Table of Contents](https://github.com/Ditectrev/Professional-Scrum-Master-I-PSM-I-Practice-Tests-Eams-Questions-Answers#table-of-contents), the wrong answer, please submit an [issue](https://github.com/Ditectrev/Professional-Scrum-Master-I-PSM-I-Practice-Tests-Eams-Questions-Answers/issues). Even better would be a [Pull Request (PR)](https://github.com/Ditectrev/Professional-Scrum-Master-I-PSM-I-Practice-Tests-Eams-Questions-Answers/pulls).

## Who this course is for:

- 👨‍🎓 Students preparing for the Professional Scrum Master I (PSM I) Eam;
- 👨‍🎓 Agile Coaches;
- 👨‍🎓 Agile Leaders;
- 👨‍🎓 DevOps Engineers;
- 👨‍🎓 IT Professionals;
...
- ✅ You can pass the Professional Scrum Master I (PSM I) Eam solely based on our Practice Tests Eams.

## Table of Contents

| No. | Questions |
| --- | --------------------------- |
| 1   | [You have just been hired by a company new to Scrum. Your management has assigned you to be the Scrum Master of si new Scrum Teams. These teams will build one product. Select two conditions you should strive for in this scenario. (choose two)](#you-have-just-been-hired-by-a-company-new-to-scrum-your-management-has-assigned-you-to-be-the-scrum-master-of-si-new-scrum-teams-these-teams-will-build-one-product-select-two-conditions-you-should-strive-for-in-this-scenario-choose-two) |
...
| 4   | [You are the Scrum Master for four Scrum Teams working from the same Product Backlog. Several of the developers come to you complaining that work identified for the upcoming two Sprints will require full-time commitment from a technical specialist who is eternal to the teams. What are two key concerns for the Scrum Master to take into account in this situation? (choose two)](#you-are-the-scrum-master-for-four-scrum-teams-working-from-the-same-product-backlog-several-of-the-developers-come-to-you-complaining-that-work-identified-for-the-upcoming-two-sprints-will-require-full-time-commitment-from-a-technical-specialist-who-is-eternal-to-the-teams-what-are-two-key-concerns-for-the-scrum-master-to-take-into-account-in-this-situation-choose-two) |
...
| 8   | [A member of the Development Team takes the Scrum Master aside to epress his concerns about data security issues. What should the Scrum Master do?](#a-member-of-the-development-team-takes-the-scrum-master-aside-to-epress-his-concerns-about-data-security-issues-what-should-the-scrum-master-do) |
...
| 18  | [Which three of the following are time-boed events in Scrum?](#which-three-of-the-following-are-time-boed-events-in-scrum-choose-the-best-three-answers)   |
| 19  | [Who is responsible for clearly epressing Product Backlog items?](#who-is-responsible-for-clearly-epressing-product-backlog-items-choose-the-best-answer)   |
...
| 45  | [A new developer is having continuing conflicts with eisting Development Team members and creating the hostile environment. If necessary, who is responsible for removing the team member?](#a-new-developer-is-having-continuing-conflicts-with-eisting-development-team-members-and-creating-the-hostile-environment-if-necessary-who-is-responsible-for-removing-the-team-member-choose-the-best-answer)   |
...
| 53  | [A Scrum Master is working with a Development Team that has members in different physical locations. The Development Team meets in a variety of meeting rooms and has much to do logistically (for eample, set up conference calls) before the Daily Scrum. What action should the Scrum Master take?](#a-scrum-master-is-working-with-a-development-team-that-has-members-in-different-physical-locations-the-development-team-meets-in-a-variety-of-meeting-rooms-and-has-much-to-do-logistically-for-eample-set-up-conference-calls-before-the-daily-scrum-what-action-should-the-scrum-master-take-choose-the-best-answer)   |
...
| 69  | [What is the time-bo for the Sprint Review?](#what-is-the-time-bo-for-the-sprint-review)   |
...
| 74  | [How is management eternal to the Scrum Team involved in the Daily Scrum?](#how-is-management-eternal-to-the-scrum-team-involved-in-the-daily-scrum)   |
...
| 77  | [What is the time-bo for the Sprint Planning meeting?](#what-is-the-time-bo-for-the-sprint-planning-meeting)   |
...
| 88  | [The time-bo for a Daily Scrum?](#the-time-bo-for-a-daily-scrum)   |
...
| 106 | [Which Scrum Values are ehibited by not building Product Backlog items that have low business value? (choose three)](#which-scrum-values-are-ehibited-by-not-building-product-backlog-items-that-have-low-business-value-choose-three) |
...
| 112 | [Currently, your Development Teams are organized to address a single layer only (for eample, front end, middle tier, back end, and interfaces). What are three things to consider when deciding to move away from such component teams toward feature teams? (choose three)](#currently-your-development-teams-are-organized-to-address-a-single-layer-only-for-eample-front-end-middle-tier-back-end-and-interfaces-what-are-three-things-to-consider-when-deciding-to-move-away-from-such-component-teams-toward-feature-teams-choose-three) |
...
| 115 | [You have si teams using a traditional method to deliver a product. Your management has asked you to start using Scrum. In the initial project there were separate plans and teams for the layers of a software system, i.e. one for the frontend, one for the middle tier, one for the back-end, and one for the interfaces and services. This resembles what is known as component teams. But you have read that it's a good idea to have teams organized by feature. What are the advantages of keeping component teams while starting Scrum?](#you-have-si-teams-using-a-traditional-method-to-deliver-a-product-your-management-has-asked-you-to-start-using-scrum-in-the-initial-project-there-were-separate-plans-and-teams-for-the-layers-of-a-software-system-ie-one-for-the-frontend-one-for-the-middle-tier-one-for-the-back-end-and-one-for-the-interfaces-and-services-this-resembles-what-is-known-as-component-teams-but-you-have-read-that-its-a-good-idea-to-have-teams-organized-by-feature-what-are-the-advantages-of-keeping-component-teams-while-starting-scrum) |
...
| 119 | [A Development Team asks their Product Owner to re-order the Product Backlog. The team is waiting for an eternal supplier to deliver a specific software component. Without that component there won't be enough work in the net Sprint to occupy the full team. The Product Owner asks the Scrum Master for help. What would be good advice to give the Product Owner?](#a-development-team-asks-their-product-owner-to-re-order-the-product-backlog-the-team-is-waiting-for-an-eternal-supplier-to-deliver-a-specific-software-component-without-that-component-there-wont-be-enough-work-in-the-net-sprint-to-occupy-the-full-team-the-product-owner-asks-the-scrum-master-for-help-what-would-be-good-advice-to-give-the-product-owner) |
...
| 122 | [What does it mean to say that an event has a time-bo?](#what-does-it-mean-to-say-that-an-event-has-a-time-bo) |
| 123 | [Which outcome is epected as Scrum Teams mature?](#which-outcome-is-epected-as-scrum-teams-mature) |
...
| 140 | [How much time is required after a Sprint to prepare for the net Sprint?](#how-much-time-is-required-after-a-sprint-to-prepare-for-the-net-sprint) |
...
| 146 | [Who is accountable for clearly epressing Product Backlog items? (choose the best answer)](#who-is-accountable-for-clearly-epressing-product-backlog-items-choose-the-best-answer) |
...
| 156 | [What activities would a Product Owner typically undertake in the phase between the end of the current Sprint and the start of the net Sprint?](#what-activities-would-a-product-owner-typically-undertake-in-the-phase-between-the-end-of-the-current-sprint-and-the-start-of-the-net-sprint)   |
...
| 170 | [A Development Team is required to deliver a done Increment by the end of a Sprint. Select two statements that eplain what "Done" means. (choose two)](#a-development-team-is-required-to-deliver-a-done-increment-by-the-end-of-a-sprint-select-two-statements-that-eplain-what-done-means-choose-two) |
...
| 176 | [A Scrum Team uses 2 weeks Sprints and time bo their Sprint Planning to 6 hours. Does this break the rules of Scrum?](#a-scrum-team-uses-2-weeks-sprints-and-time-bo-their-sprint-planning-to-6-hours-does-this-break-the-rules-of-scrum) |
| 177 | [Who is accountable for ensuring that the burn-down chart and gantt chart eist?](#who-is-accountable-for-ensuring-that-the-burn-down-chart-and-gantt-chart-eist) |
...
| 186 | [Among the Developers, there is nobody with significant testing epertise. They should...(pick 2)](#among-the-developers-there-is-nobody-with-significant-testing-epertise-they-should)   |
...
| 206 | [Select the correct timebo for each Scrum event.](#select-the-correct-timebo-for-each-scrum-event)   |
...
| 218 | [The timebo for a Daily Scrum is?(choose the best answer)](#the-timebo-for-a-daily-scrum-is) |
| 219 | [The three pillars of empiricism are:(choose the best answer)](#the-three-pillars-of-empiricism-are) |
| 220 | [What does it mean to say that an event has a timebo?(choose the best answer)](#what-does-it-mean-to-say-that-an-event-has-a-timebo) |
...
| 223 | [The timebo for the Sprint Review is:](#the-timebo-for-the-sprint-review-is) |
...
| 228 | [The timebo for the Sprint Planning event is?](#the-timebo-for-the-sprint-planning-event-is) |
...
| 234 | [Which of the following are eamples of a Scrum Team practicing Scrum poorly or not ehibiting traits of a self-managing Scrum Team?(choose the best three answers)](#which-of-the-following-are-eamples-of-a-scrum-team-practicing-scrum-poorly-or-not-ehibiting-traits-of-a-self-managing-scrum-team) |
...
| 239 | [Who should know the most about the progress toward a business objective or a release, and be able to eplain the alternatives most clearly?(choose the best answer)](#who-should-know-the-most-about-the-progress-toward-a-business-objective-or-a-release-and-be-able-to-eplain-the-alternatives-most-clearly) |
...
| 242 | [When does the net Sprint begin?](#when-does-the-net-sprint-begin) |
...
### You have just been hired by a company new to Scrum. Your management has assigned you to be the Scrum Master of si new Scrum Teams. These teams will build one product. Select two conditions you should strive for in this scenario. (choose two)

- [ ] There should be si Product Owners, one for each Scrum Team.
- [ ] There should be si Product Owners, reporting to a chief Product Owner.
...
- [ ]  The Sprint is etended and future Sprints use this new duration.
...
- [ ] The Sprint is etended temporarily. Lessons are taken to ensure it doesn't happen again.
...
### A member of the Development Team takes the Scrum Master aside to epress his concerns about data security issues. What should the Scrum Master do?

- [ ] Add security to the definition of "Done".
- [ ] Tell the Product Owner to stop further development of features until the issues are fied.
...
- [] The Scrum Master teaches the Development Team to keep the Scrum meetings to their time-bo.
...
### Which three of the following are time-boed events in Scrum? (choose the best three answers)
...
### Who is responsible for clearly epressing Product Backlog items? (choose the best answer)
...
- [ ] Ask an eternal technical specialist to make the decision.
- [ ] Send every team member to the company's Human Resources department to epress their concerns.
...
- [ ] At least one representative from each major software engineering discipline (like QA, Dev, U).
...
- [ ] To know what the team will deliver over the net three Sprints.
...
- [ ] Do all of the development work, ecept for specialized testing that requires additional tools and environments.
...
- [ ] Suggest the Product Owner etend the Sprint, so he can have more time to order the Product Backlog.
- [ ] Suggest that the Development Team does the ordering to be sure that it is a feasible ordering of work.
- [] Offer the Product Owner help in understanding that the goal of ordering the Product Backlog is to maimize value.
...
- [] It is when the Scrum Team and stakeholders inspect the outcome of a Sprint and figure out what to do net.
...
### A new developer is having continuing conflicts with eisting Development Team members and creating the hostile environment. If necessary, who is responsible for removing the team member? (choose the best answer)
...
- [ ] Describe the purpose, objective, and time-bo of each Scrum event.
...
- [] Identifying high priority process improvements for the net Sprint.
- [ ] The order of items in the Product Backlog.
- [] How the team collaborates.
- [ ] Documenting acceptance criteria for items in the net Sprint.
...
- [] How will we make sure all teams have the right amount or epertise?
- [ ] What is the right miture of senior and junior people on each team?
- [ ] Who are going to be the team leads?
- [ ] Who are the subject matter eperts on each team?
...
- [] Teach the Development Team to keep the Daily Scrum within the 15 minute time-bo.
- [ ] All of the above.
...
### What is the time-bo for the Sprint Review?
...
### How is management eternal to the Scrum Team involved in the Daily Scrum?
...
### What is the time-bo for the Sprint Planning meeting?
...
- [] Eisting teams propose how they would like to go about organizing into the new structure.
...
- [] The Development Team makes sure that all of the selected scope per Sprint is as "Done" as possible. The undone work is estimated and added to the Sprint
...
- [ ] Add the item to the net Sprint.
...
- [ ] Failing unit tests, to identify acceptance tests for the net Sprint.
...
- [ ] The most senior people in the organization, including architects and subject matter eperts.
- [ ] The Scrum Master.
...
- [ ] The person coming in last. This encourages people to be on time and helps to stay within the time-bo.
- [] Whoever the Development Team decides should start.
- [ ] The person who has the token.
- [ ] The Scrum Master. This ensures that the Development Team has the meeting and stays within the time-bo.
...
- [] Ask the Product Owner to discuss the product or project, its history, goals, and contet, as well as answer questions.
...
- [] A framework within which comple products in comple environments are developed.

**[⬆ Back to Top](#table-of-contents)**

### Which Scrum Values are ehibited by not building Product Backlog items that have low business value? (choose three)
...
### Currently, your Development Teams are organized to address a single layer only (for eample, front end, middle tier, back end, and interfaces). What are three things to consider when deciding to move away from such component teams toward feature teams? (choose three)
...
### You have si teams using a traditional method to deliver a product. Your management has asked you to start using Scrum. In the initial project there were separate plans and teams for the layers of a software system, i.e. one for the frontend, one for the middle tier, one for the back-end, and one for the interfaces and services. This resembles what is known as component teams. But you have read that it's a good idea to have teams organized by feature. What are the advantages of keeping component teams while starting Scrum?
...
### A Development Team asks their Product Owner to re-order the Product Backlog. The team is waiting for an eternal supplier to deliver a specific software component. Without that component there won't be enough work in the net Sprint to occupy the full team. The Product Owner asks the Scrum Master for help. What would be good advice to give the Product Owner?

- [] Remind the Product Owner that his primary concern is the flow of value reflected in the ordering of the Product Backlog.
- [ ] Tell the Product Owner to re-order the Product Backlog so the work involving the eternal component can be planned in a separate sprint.
- [ ] Tell the Product Owner that the Product Backlog should be ordered to maimize utilization of the Development Team.
...
### What does it mean to say that an event has a time-bo?

- [ ] The event must happen at a set time.
- [ ] The event must happen by a given time.
- [ ] The event must take at least a minimum amount of time.
- [] The event can take no more than a maimum amount of time.

**[⬆ Back to Top](#table-of-contents)**

### Which outcome is epected as Scrum Teams mature?
...
- [ ] There is no need for a time-boed Sprint, since time-boes are only for new Scrum Teams.
...
- [] Forecast the most likely Product Backlog items to meet the goal and create a Sprint Backlog based on a likely initial design and plan. Once the time-bo for the Sprint Planning meeting is over, start the Sprint and continue to analyze, decompose, and create additional functionality during the Sprint.
- [ ] Continue the Sprint Planning meeting past its time-bo until an adequate number of Product Backlog items are well enough understood for the Development Team to make a complete forecast. Then start the Sprint.
...
- [] To inspect the product increment with the stakeholders and collect feedback on net steps.
...
- [] Add them to the Product Backlog and keep the Product Owner posted on the epected effort.
- [ ] Run the integration and regression tests before the end of the Sprint, and capture the open work for the Sprint Backlog of the net Sprint.
- [ ] Run the integration and regression tests before the end of the Sprint, and capture the open work for the Sprint Backlog of the net Sprint.
- [] Add them to the definition of "Done" so the work is taken care of every Sprint.

**[⬆ Back to Top](#table-of-contents)**

### How much time is required after a Sprint to prepare for the net Sprint?

- [ ] The break between Sprints is time-boed to 1 week for 30 day Sprints, and usually less for shorter sprints.
- [ ] Enough time for the requirements for the net Sprint to be determined and documented.
...
- [ ] When functional epectations are not well understood.
...
- [] The Scrum Team may add items to the Sprint Backlog for the net Sprint.
...
- [] Use coaching techniques; such as open questions and active listening.
- [ ] Ask an eternal agile coach what they recommend.
- [ ] Ask team members to take the issue up with to the company's Human Resources department.

**[⬆ Back to Top](#table-of-contents)**

### Who is accountable for clearly epressing Product Backlog items? (choose the best answer)
...
- [ ] Find another Scrum Team to give the ecess work to.
...
### What activities would a Product Owner typically undertake in the phase between the end of the current Sprint and the start of the net Sprint?

- [] There are no such activities. The net Sprint starts immediately after the current Sprint.
...
- [ ] Create a matri of skills, seniority, and level of eperience to assign people to teams.
...
- [ ] Whenever the product is free of defects.
- [ ] After every Sprint, Without eception.
...
- [ ] When calculated and estimated, the total amount of technical debt shows eactly how long until the Product Owner can release the Increment.
...
### A Development Team is required to deliver a done Increment by the end of a Sprint. Select two statements that eplain what "Done" means. (choose two)
...
### A Scrum Team uses 2 weeks Sprints and time bo their Sprint Planning to 6 hours. Does this break the rules of Scrum?
...
### Who is accountable for ensuring that the burn-down chart and gantt chart eist?
...
- [] Additional facilitation may be required to keep to the time-bo.
...
### Among the Developers, there is nobody with significant testing epertise. They should...
...
- [ ] The team has a good mi of skills.
...
- [] A revised Product Backlog that defines the probable Product Backlog items for the net Sprint.
...
- [] The Scrum Master should help the Developers understand why the 15 minute time-bo should be respected and help them find ways to do it as required.
...
### Select the correct timebo for each Scrum event.
...
- [] True - As long as a product eists, its Product Backlog also eists.
...
- [ ] Do nothing, the Developers must fi its own issues.
...
- [] Turn the Product Backlog items they select into an Increment of useful andvaluable product functionality.
- [ ] Do all of the development work, ecept for specialized testing that requires additional tools and environments.
...
### The timebo for a Daily Scrum is?
...
### What does it mean to say that an event has a timebo?
...
### The timebo for the Sprint Review is:
...
- [] The consistency reduces compleity.
...
### The timebo for the Sprint Planning event is?
...
- [] Support the Product Owner with insights and information into high value product and system capabilties. Support the Scrum Master to encourage organizational change that fosters empiricism, self-management, bottom-up intelligence, and intelligent product delivery.
...
- [ ] Management may feel less anious
- [] Al of the above

**[⬆ Back to Top](#table-of-contents)**

### Which of the following are eamples of a Scrum Team practicing Scrum poorly or not ehibiting traits of a self-managing Scrum Team?
...
- [] The Developers invite eternal stakeholders to the Sprint Planning tosk them how to turn a Product Backlog item into an Increment via a complete and detailed Sprint Backlog
...
### Who should know the most about the progress toward a business objective or a release, and be able to eplain the alternatives most clearly?
...
- [] Teach the Developers to keep the Daily Scrum within the 15 minute timebo.
...
- [ ] The Developers may work with the Product Owner to add or remove work if they find themselves with more or less capacity than epected.
...
### When does the net Sprint begin?

- [ ] Net Monday.
- [] Immediately after the conclusion of the previous Sprint.
- [ ] Immediately following the net Sprint Planning.
